...
% Turn y into rows of 1s and 0s corresponding to the results
Y=[];
for i=1:m
...
J = 1/m * sum(sum(-Y.*log(h) - (1-Y).*log(1-h),2)) + J_reg;
...
% Dimensions a2:5000x26 delta3:5000x10 delta2:5000x25 a1:5000x401
% DELTA2:10x26 DELTA1:25x401
